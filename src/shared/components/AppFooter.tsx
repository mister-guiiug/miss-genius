...
const linkClass =
  'inline-flex items-center justify-center gap-2 rounded-full min-h-11 px-4 text-sm font-semibold ' +
  'bg-[var(--mg-surface-2)] border border-[var(--mg-border)] text-[var(--mg-text)] active:scale-[0.97]';
