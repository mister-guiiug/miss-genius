 ...
 *
 * Stratégie volontairement « marteau » (adaptée à une action manuelle explicite) :
...
export async function forceUpdate(): Promise<void> {
  try {
    if ('serviceWorker' in navigator) {
      ...
      // Tente d'abord la voie propre : activer un SW déjà en attente.
      ...
      if (hasWaiting) {
        ...
        // Aucune version en attente : on force un re-téléchargement complet.
    ...
    console.warn('[miss-genius] forceUpdate', err);
  } finally {
